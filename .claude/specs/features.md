...
| Feature | Status | Plan | Notes |
|---|---|---|---|
| Homepage — A Story in Silk | `done` | `done-02-silk-story-liquid-port.md` | Scroll-driven cross-fade between full-bleed story scenes; card/scene blocks; soft add-to-cart; filmstrip progress; immersive layout with no nav/footer |
...
| Silk Story — Liquid port + soft commerce | `done` | `done-02-silk-story-liquid-port.md` | "A Story in Silk" chosen over the Atelier Table and shipped as the homepage. Scene videos and photos still to be added |
